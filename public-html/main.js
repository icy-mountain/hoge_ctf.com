...
const test_modal4 = new Modal({ genre: "app", title: "#1: 四則演算100本ノック 500pt", text: `<p>Macならターミナルを開いて下のコマンドを入力してね！Windowsだと対応してないのでムリです！WSL入れたらイケるよ。相談してね！</p><p>2021年8月でAWSのクレジットが無くなってしまったため、サーバーへアクセスできません。アクセスして遊んでみたい人は相談してね！</p><samp class="d-block bg-dark text-white">nc 3.88.122.62 8888</samp><br>` });
